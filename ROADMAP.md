...
- **Progress**: 275/310 steps complete (89%) — Phases 14, 15, 20, 24 done. 16 (7/8), 17 (7/9), 18 (3/7), 19 (2/7), 21 (5/8), 23 (7/9) in progress
- **Phase 23 (partial)**: Real plugin compaction — form-ID renumbering + reference re-pointing. Build clean, 58/58 tests.
