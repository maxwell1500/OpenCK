...
- **Progress**: 233/310 steps complete (75%) — Phase 14 + 15 complete; Phase 16 in progress (5/8)
- **Phase 16 (partial)**: PACK/WRLD/LCTN specialized factory widgets + NAVM record binding + EFSH/IMGS raw-subrecord inspector. Build clean, 32/32 tests.
