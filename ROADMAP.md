...
- **Progress**: 232/310 steps complete (75%) — Phase 14 + 15 complete; Phase 16 in progress (4/8)
- **Phase 16 (partial)**: PACK/WRLD/LCTN specialized factory widgets + NAVM record binding (editSelected opens NavmeshEditorDialog seeded from NavmRecord with undoable write-back). Build clean, 32/32 tests.
