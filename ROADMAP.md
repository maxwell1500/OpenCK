...
- **Progress**: 270/310 steps complete (87%) — Phases 14, 15, 24 done. 16 (7/8), 17 (6/9), 18 (2/7), 19 (1/7), 20 (4/5), 21 (5/8), 23 (6/9) in progress
- **Phase 21 (partial)**: Papyrus Script Manager dialog (list/filter/new/open .psc). Build clean, 54/54 tests.
