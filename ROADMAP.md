...
- **Progress**: 257/310 steps complete (83%) — Phases 14+15 complete; 16 (6/8), 17 (5/9), 18 (1/7), 20 (1/5), 21 (1/8), 23 (5/9), 24 (10/11) in progress
- **Phase 21 (partial)**: `.flg` Papyrus script property flag parser + validator wired into PapyrusCompiler. Build clean, 42/42 tests.
