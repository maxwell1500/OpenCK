...
static const TypeData typesIdArg[] =
{
    ...
    { CkId::Type_Bptd_, "Behavior Pattern" },
    { CkId::Type_Cams_, "Camera Shot" },
    { CkId::Type_Chal_, "Challenge" },
    { CkId::Type_Cldf_, "Character Float Table" },
    { CkId::Type_Cndf_, "Character Data" },
    { CkId::Type_Coll_, "Collision" },
    { CkId::Type_Cpth_, "Camera Path" },
    { CkId::Type_Dlbr_, "Culling Data" },
    ...
    { CkId::Type_Efsq_, "Effect Shader 2" },
    { CkId::Type_Equp_, "Equipment Slot" },
    { CkId::Type_Ffkw_, "Furnishing Keyword" },
    { CkId::Type_Fogv_, "Fog Volume" },
    { CkId::Type_Forc_, "Force Field" },
    { CkId::Type_Fstp_, "Footstep Set" },
    { CkId::Type_Fsts_, "Footstep Sound" },
    { CkId::Type_Fxpd_, "FX Particle" },
    { CkId::Type_Gbfm_, "Biome Mask" },
    { CkId::Type_Gbft_, "Biome Type" },
    { CkId::Type_Gcvr_, "Gravity Camera" },
    { CkId::Type_Imad_, "Image Space Adapter" },
    { CkId::Type_Innr_, "Interior Data" },
    { CkId::Type_Ires_, "Resource Property" },
    { CkId::Type_Kssm_, "Keyword Set" },
    { CkId::Type_Layr_, "Layer" },
    { CkId::Type_Lens_, "Lens" },
    { CkId::Type_Lgdi_, "Landscape Grid Data" },
    { CkId::Type_Lgtm_, "Light Template" },
    { CkId::Type_Lmsw_, "Lens Modifier Set" },
    { CkId::Type_Lvlb_, "Leveled Biome" },
    { CkId::Type_Lvln_, "Leveled Node" },
    { CkId::Type_Lvlp_, "Leveled Perk" },
    { CkId::Type_Lvsc_, "Leveled Structure" },
    { CkId::Type_Maam_, "Material Attachment" },
    { CkId::Type_Mrhp_, "Mesh Renderer" },
    { CkId::Type_Mtpt_, "Mount Point" },
    { CkId::Type_Navi_, "Navigation Island" },
    { CkId::Type_Nocm_, "Navigation Component" },
    { CkId::Type_Omod_, "Object Mod" },
    { CkId::Type_Oswp_, "Object Swap Set" },
    { CkId::Type_Ovis_, "Object Visual" },
    { CkId::Type_Pcbn_, "Placement Configuration" },
    { CkId::Type_Pccn_, "Placement Collision Node" },
    { CkId::Type_Pcmt_, "Placement Material" },
    { CkId::Type_Pdcl_, "Particle Decal" },
    { CkId::Type_Pgre_, "Particle Emitter" },
    { CkId::Type_Phzd_, "PHZD" },
    { CkId::Type_Pkin_, "PKIN" },
    { CkId::Type_Pmft_, "PMFT" },
    { CkId::Type_Psdc_, "PSDC" },
    { CkId::Type_Ptst_, "PTST" },
    { CkId::Type_Rfgp_, "RFGP" },
    { CkId::Type_Rsgd_, "RSGD" },
    { CkId::Type_Rspj_, "RSPJ" },
    { CkId::Type_Sdlt_, "SDLT" },
    { CkId::Type_Sech_, "SECH" },
    { CkId::Type_Sfbk_, "SFBK" },
    { CkId::Type_Sfpc_, "SFPC" },
    { CkId::Type_Sfpt_, "SFPT" },
    { CkId::Type_Sftr_, "SFTR" },
    { CkId::Type_Smbn_, "SMBN" },
    { CkId::Type_Smen_, "SMEN" },
    { CkId::Type_Spch_, "SPCH" },
    { CkId::Type_Stag_, "STAG" },
    { CkId::Type_Stbh_, "STBH" },
    { CkId::Type_Stdt_, "STDT" },
    { CkId::Type_Stmp_, "STMP" },
    { CkId::Type_Stnd_, "STND" },
    { CkId::Type_Sunp_, "SUNP" },
    { CkId::Type_Tmlm_, "TMLM" },
    { CkId::Type_Todd_, "TODD" },
    { CkId::Type_Trav_, "TRAV" },
    { CkId::Type_Trns_, "TRNS" },
    { CkId::Type_Voli_, "VOLI" },
    { CkId::Type_Vtyp_, "VTYP" },
    { CkId::Type_Wbar_, "WBAR" },
    { CkId::Type_Wkmf_, "WKMF" },
    { CkId::Type_Wths_, "WTHS" },
    { CkId::Type_Wwed_, "WWED" },
    { CkId::Type_Zoom_, "ZOOM" },
    { CkId::Type_None, 0 }
};
...
static const TypeData typesNoArg[] =
{
    ...
    { CkId::Type_Bnds_, "Bounds" },
    { CkId::Type_Bptd_, "Behavior Patterns" },
    { CkId::Type_Cams_, "Camera Shots" },
    { CkId::Type_Chal_, "Challenges" },
    { CkId::Type_Cldf_, "Character Float Tables" },
    { CkId::Type_Cndf_, "Character Data" },
    ...
    { CkId::Type_Efsq_, "Effect Shaders 2" },
    { CkId::Type_Equp_, "Equipment Slots" },
    { CkId::Type_Ffkw_, "Furnishing Keywords" },
    { CkId::Type_Fogv_, "Fog Volumes" },
    { CkId::Type_Forc_, "Force Fields" },
    { CkId::Type_Fstp_, "Footstep Sets" },
    { CkId::Type_Fsts_, "Footstep Sounds" },
    { CkId::Type_Fxpd_, "FX Particles" },
    { CkId::Type_Gbfm_, "Biome Masks" },
    { CkId::Type_Gbft_, "Biome Types" },
    { CkId::Type_Gcvr_, "Gravity Cameras" },
    { CkId::Type_Imad_, "Image Space Adapters" },
    { CkId::Type_Innr_, "Interior Data" },
    { CkId::Type_Ires_, "Resource Properties" },
    { CkId::Type_Kssm_, "Keyword Sets" },
    { CkId::Type_Layr_, "Layers" },
    { CkId::Type_Lens_, "Lenses" },
    { CkId::Type_Lgdi_, "Landscape Grid Data" },
    { CkId::Type_Lgtm_, "Light Templates" },
    { CkId::Type_Lmsw_, "Lens Modifier Sets" },
    { CkId::Type_Lvlb_, "Leveled Biomes" },
    { CkId::Type_Lvln_, "Leveled Nodes" },
    { CkId::Type_Lvlp_, "Leveled Perks" },
    { CkId::Type_Lvsc_, "Leveled Structures" },
    { CkId::Type_Maam_, "Material Attachments" },
    { CkId::Type_Mrhp_, "Mesh Renderers" },
    { CkId::Type_Mtpt_, "Mount Points" },
    { CkId::Type_Navi_, "Navigation Islands" },
    { CkId::Type_Nocm_, "Navigation Components" },
    { CkId::Type_Omod_, "Object Mods" },
    { CkId::Type_Oswp_, "Object Swap Sets" },
    { CkId::Type_Ovis_, "Object Visuals" },
    { CkId::Type_Pcbn_, "Placement Configuration" },
    { CkId::Type_Pccn_, "Placement Collision Nodes" },
    { CkId::Type_Pcmt_, "Placement Materials" },
    { CkId::Type_Pdcl_, "Particle Decals" },
    { CkId::Type_Pgre_, "Particle Emitters" },
    { CkId::Type_Phzd_, "PHZD" },
    { CkId::Type_Pkin_, "PKIN" },
    { CkId::Type_Pmft_, "PMFT" },
    { CkId::Type_Psdc_, "PSDC" },
...
CkId::Type CkId::stringToType(const QString& typeName)
{
    ...
    if (!disk.isEmpty())
    {
        static const struct { CkId::Type type; const char* disk; } diskAliases[] = {
            ...
            { Type_Bmod_, "BMOD" }, { Type_Bnds_, "BNDS" }, { Type_Bptd_, "BPTD" },
            { Type_Cams_, "CAMS" }, { Type_Chal_, "CHAL" }, { Type_Cldf_, "CLDF" },
            { Type_Cndf_, "CNDF" }, { Type_Coll_, "COLL" }, { Type_Cpth_, "CPTH" },
            { Type_Dlbr_, "DLBR" }, { Type_Cur3_, "CUR3" }, { Type_Curv_, "CURV" },
            { Type_Dfob_, "DFOB" }, { Type_Dmgt_, "DMGT" }, { Type_Dobj_, "DOBJ" },
            { Type_Efsq_, "EFSQ" }, { Type_Equp_, "EQUP" },
            { Type_Ffkw_, "FFKW" },
            { Type_Fogv_, "FOGV" },
            { Type_Forc_, "FORC" },
            { Type_Fstp_, "FSTP" },
            ...
            { Type_Pdcl_, "PDCL" },
            { Type_Pgre_, "PGRE" },
            { Type_Phzd_, "PHZD" }, { Type_Pkin_, "PKIN" },
            { Type_Pmft_, "PMFT" }, { Type_Psdc_, "PSDC" },
            { Type_Ptst_, "PTST" }, { Type_Rfgp_, "RFGP" },
            { Type_Rsgd_, "RSGD" }, { Type_Rspj_, "RSPJ" },
            { Type_Sdlt_, "SDLT" }, { Type_Sech_, "SECH" },
            { Type_Sfbk_, "SFBK" }, { Type_Sfpc_, "SFPC" },
            { Type_Sfpt_, "SFPT" }, { Type_Sftr_, "SFTR" },
            { Type_Smbn_, "SMBN" }, { Type_Smen_, "SMEN" },
            { Type_Spch_, "SPCH" }, { Type_Stag_, "STAG" },
            { Type_Stbh_, "STBH" }, { Type_Stdt_, "STDT" },
            { Type_Stmp_, "STMP" }, { Type_Stnd_, "STND" },
            { Type_Sunp_, "SUNP" }, { Type_Tmlm_, "TMLM" },
            { Type_Todd_, "TODD" }, { Type_Trav_, "TRAV" },
            { Type_Trns_, "TRNS" }, { Type_Voli_, "VOLI" },
            { Type_Vtyp_, "VTYP" }, { Type_Wbar_, "WBAR" },
            { Type_Wkmf_, "WKMF" }, { Type_Wths_, "WTHS" },
            { Type_Wwed_, "WWED" }, { Type_Zoom_, "ZOOM" },
        };
