...
| 22 — Behavior / Animation Graph Editor | 3/5 | ◐ |
...
Phase 22: Behavior / animation graph editor (node-graph canvas, 20-type palette, event validation done; variable nodes, blend-tree weights pending)
