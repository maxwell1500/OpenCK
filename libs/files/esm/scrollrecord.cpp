...
void ScrRecord::load(ESMReader& esm, bool)
{
...
void ScrRecord::save(ESMWriter& esm) const
{
...
void ScrRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
