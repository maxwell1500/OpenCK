#include "clothrecord.hpp"
#include "esmreader.hpp"
#include "esmwriter.hpp"
void ClotRecord::load(ESMReader& esm, bool) {
...
void ClotRecord::save(ESMWriter& esm) const {
...
void ClotRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
