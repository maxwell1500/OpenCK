#ifndef StmpRecordRECORD_H
#define StmpRecordRECORD_H
#include "records.hpp"
#include "variant.hpp"
...
struct StmpRecord {
    ...
    std::shared_ptr<StmpRecord> verbatimSnapshot;
...
inline bool operator==(const StmpRecord& l, const StmpRecord& r)
{
