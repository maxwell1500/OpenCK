...
void ProjRecord::load(ESMReader& esm, bool)
{
...
void ProjRecord::save(ESMWriter& esm) const
{
...
void ProjRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
