...
void ClimateRecord::load(ESMReader& esm, bool) {
...
void ClimateRecord::save(ESMWriter& esm) const {
...
void ClimateRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
