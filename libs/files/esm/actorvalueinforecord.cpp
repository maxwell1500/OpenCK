#include "actorvalueinforecord.hpp"
#include "esmreader.hpp"
#include "esmwriter.hpp"
void ActorValueInfoRecord::load(ESMReader& esm, bool) {
...
void ActorValueInfoRecord::save(ESMWriter& esm) const {
...
void ActorValueInfoRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
