#include "lvspellrecord.hpp"
#include "esmreader.hpp"
#include "esmwriter.hpp"

void LvspRecord::load(ESMReader& esm, bool)
{
...
void LvspRecord::save(ESMWriter& esm) const
{
...
void LvspRecord::blank() { editorId = ""; formId = 0; flags = 0; chanceNone = 0; levelFlags = 0; levelFlagsSize = 1; entries.clear(); rawSubRecords.clear(); components.clear(); }
