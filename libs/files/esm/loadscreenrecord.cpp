...
void LoadScreenRecord::load(ESMReader& esm, bool) {
...
void LoadScreenRecord::save(ESMWriter& esm) const {
...
void LoadScreenRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
