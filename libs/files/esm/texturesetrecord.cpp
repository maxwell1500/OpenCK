...
void TextureSetRecord::load(ESMReader& esm, bool) {
...
void TextureSetRecord::save(ESMWriter& esm) const {
...
void TextureSetRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
