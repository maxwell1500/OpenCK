#include "roadrecord.hpp"
#include "esmreader.hpp"
#include "esmwriter.hpp"
void RoadRecord::load(ESMReader& esm, bool) {
...
void RoadRecord::save(ESMWriter& esm) const {
...
void RoadRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
