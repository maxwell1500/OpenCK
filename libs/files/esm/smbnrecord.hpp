#ifndef SmbnRecordRECORD_H
#define SmbnRecordRECORD_H
#include "records.hpp"
#include "variant.hpp"
...
struct SmbnRecord {
    ...
    std::shared_ptr<SmbnRecord> verbatimSnapshot;
...
inline bool operator==(const SmbnRecord& l, const SmbnRecord& r)
{
