...
void CstyRecord::load(ESMReader& esm, bool) {
...
void CstyRecord::save(ESMWriter& esm) const {
...
void CstyRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
