#include "staticcollectionrecord.hpp"
#include "esmreader.hpp"
#include "esmwriter.hpp"
void StaticCollectionRecord::load(ESMReader& esm, bool) {
...
void StaticCollectionRecord::save(ESMWriter& esm) const {
...
void StaticCollectionRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
