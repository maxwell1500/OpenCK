...
void GrassRecord::load(ESMReader& esm, bool) {
...
void GrassRecord::save(ESMWriter& esm) const {
...
void GrassRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
