#include "eyesrecord.hpp"
#include "esmreader.hpp"
#include "esmwriter.hpp"
void EyesRecord::load(ESMReader& esm, bool) {
...
void EyesRecord::save(ESMWriter& esm) const {
    esm.writeSubZString('EDID', editorId);
    components.saveAll(esm);
    for (const auto& raw : rawSubRecords) { esm.writeRawSubRecord(raw); }
}
void EyesRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
