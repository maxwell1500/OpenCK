#include "soundmarkerrecord.hpp"
#include "esmreader.hpp"
#include "esmwriter.hpp"
void SmqnRecord::load(ESMReader& esm, bool) {
...
void SmqnRecord::save(ESMWriter& esm) const {
...
void SmqnRecord::blank() { editorId = ""; formId = 0; flags = 0; rawSubRecords.clear(); components.clear(); }
