#ifndef SfbkRecordRECORD_H
#define SfbkRecordRECORD_H
#include "records.hpp"
#include "variant.hpp"
...
struct SfbkRecord {
    ...
    std::shared_ptr<SfbkRecord> verbatimSnapshot;
...
inline bool operator==(const SfbkRecord& l, const SfbkRecord& r)
{
