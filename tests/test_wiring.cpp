...
static const TypeDisk kNewlyAliased[] = {
    ...
    { CkId::Type_Bptt_, "BPTT" }, { CkId::Type_Cams_, "CAMS" },
    { CkId::Type_Chal_, "CHAL" }, { CkId::Type_Cift_, "CIFT" },
    { CkId::Type_Cnda_, "CNDA" }, { CkId::Type_Coll_, "COLL" },
    { CkId::Type_Cpth_, "CPTH" }, { CkId::Type_Culk_, "CULK" },
    { CkId::Type_Cur3_, "CUR3" }, { CkId::Type_Curv_, "CURV" },
    { CkId::Type_Dfob_, "DFOB" }, { CkId::Type_Dmgt_, "DMGT" },
    { CkId::Type_Dobj_, "DOBJ" }, { CkId::Type_Efsr_, "EFSR" },
